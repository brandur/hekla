...
xml.feed "xml:lang" => "en-US", :xmlns => "http://www.w3.org/2005/Atom" do
  xml.title "Mutelight"
  xml.id "tag:mutelight.org:/articles"
  ...
  for article in @articles
    xml.entry do
      ...
      xml.link "http://mutelight.org#{article.to_path}"
      xml.id "tag:mutelight.org,#{article.published_at.strftime('%F')}:http://mutelight.org#{article.to_path}.html"
      xml.author do
